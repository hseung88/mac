...
def create_optimizer_v2(
    ...
    #    optimizer.model = model_or_params
        ...
        opt_args.pop('eps', None)
        optimizer = MAC(parameters, momentum=0.9, stat_decay=0.95, damping=1.0, Tcov=5, Tinv=50, **opt_args)   
    elif opt_lower == 'smac':
        opt_args.pop('eps', None)
        optimizer = SMAC(parameters, momentum=0.9, stat_decay=0.95, damping=1.0, Tcov=5, Tinv=50, **opt_args) 
