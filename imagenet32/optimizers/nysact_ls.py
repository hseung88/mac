...
class NysAct_LS(Optimizer):
    ...
    def __init__(self,
        ...
        super(NysAct_LS, self).__init__(params, defaults)
    ...
    def _store_input(self, module, forward_input, forward_output):
        ...
        if module.bias is not None:
            actv = torch.cat([actv, torch.ones((batch_size, 1), device=actv.device)], dim=1)
        ...
        self.sketch_mat[module] = topk_indices
        C = torch.matmul(actv.t(), actv[:, topk_indices] / batch_size) 
