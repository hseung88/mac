...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.1, momentum=0.9, stat_decay=0.9,
    ...
    name = {
        ...
        'mac': 'lr{}-betas{}-{}-damping{}-wdecay{}-eps{}-tcov{}-tinv{}-projection{}-lr_sched{}-batchsize{}-epoch{}-run{}'.format(
            lr, beta1, beta2, damping, weight_decay, eps, tcov, tinv, projection, lr_scheduler, batchsize, epoch,
            run),
...
def create_optimizer(args, model_params):
    ...
    #               weight_decay=args.weight_decay, Tcov=args.tcov, Tinv=args.tinv, projection=args.projection)
        ...
        return MAC(model_params, args.lr, beta1=args.beta1, beta2=args.beta2, eps=args.eps, damping=args.damping,
